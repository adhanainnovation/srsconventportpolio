...
const Events = () => {
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {categoryData.events.map((event, index) => (
          <div key={index} className="bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
            <div className="p-6">
              <h4 className="text-xl font-bold mb-2 text-teal-700">{event.title}</h4>
  ...
  return (
    <div className="bg-gradient-to-b from-teal-100 via-yellow-50 to-orange-100 container mx-auto px-4 py-16 mt-[8%]">
